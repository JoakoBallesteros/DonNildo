  ...
  export default function Modified({
    ...
    const handleChange = (i, key, value) => {
      ...
      updated[i][key] = value;
        ...
        const descuento = parseFloat(updated[i].descuento) || 0;

        // Subtotal y total se recalculan según el descuento
        const subtotalBase = cantidad * precio;
        const subtotalConDescuento = subtotalBase * (1 - descuento / 100);

        updated[i].subtotal = subtotalConDescuento.toFixed(2);
        updated[i].total = subtotalConDescuento.toFixed(2);
      }
